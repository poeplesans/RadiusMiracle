                                ...
                                <div class="row mb-3 g-3">
                                    ...
                                    <div class="col-12 col-md-12">
                                        ...
                                        <input type="email" class="form-control" id="ecommerce-settings-sender-email"
                                            placeholder="johndoe@gmail.com" name="sender_email"
                                            aria-label="sender email" />
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <label class="form-label mb-0"
                                            for="ecommerce-settings-sender-email">Latitude</label>
                                        <input type="email" class="form-control" id="ecommerce-settings-sender-email"
                                            placeholder="johndoe@gmail.com" name="sender_email"
                                            aria-label="sender email" />
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <label class="form-label mb-0"
                                            for="ecommerce-settings-sender-email">Longitude</label>
                                        <input type="email" class="form-control" id="ecommerce-settings-sender-email"
                                            placeholder="johndoe@gmail.com" name="sender_email"
                                            aria-label="sender email" />
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row mb-3 g-3">
                                    <div class="col-12 col-md-6">
                                        ...
                                        <select id="currency-store" class=" form-select"
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="row mb-3 g-3">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <label class="form-label mb-0"
                                            for="ecommerce-settings-details-phone">Phone</label>
                                        <input type="tel" class="form-control phone-mask"
                                            id="ecommerce-settings-details-phone" placeholder="+(123) 456-7890"
                                            name="phone" aria-label="phone" />
                                    </div>
                                    ...
                                    <div class="col-12 col-md-6">
                                        <label class="form-label mb-0" for="ecommerce-settings-details-email">Store
                                            contact
                                            email</label>
                                        <input type="email" class="form-control" id="ecommerce-settings-details-email"
                                            placeholder="johndoe@gmail.com" name="email" aria-label="email" />
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="row mb-3 g-3">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <label class="form-label mb-0"
                                            for="ecommerce-settings-details-email">Username</label>
                                        <input type="email" class="form-control" id="ecommerce-settings-details-email"
                                            placeholder="johndoe@gmail.com" name="email" aria-label="email" />
                                    </div>
                                    ...
                                    <div class="col-12 col-md-6">
                                        <label class="form-label mb-0"
                                            for="ecommerce-settings-sender-email">Password</label>
                                        <input type="email" class="form-control" id="ecommerce-settings-sender-email"
                                            placeholder="johndoe@gmail.com" name="sender_email"
                                            aria-label="sender email" />
                                    </div>
                                ...
                                <div class="row mb-3 g-3">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <label class="form-label mb-0" for="ecommerce-settings-sender-email">Server
                                            Key</label>
                                        <input type="email" class="form-control" id="ecommerce-settings-sender-email"
                                            placeholder="xxxxxxxxxxxxxxxxx" name="sender_email"
                                            aria-label="sender email" />
                                    </div>
                                </div>
                            </div>
                                        ...
                                        @foreach ($invoice as $item)
                                            <tr>
                                                <td class="small text-center"><a
                                                        href="app-ecommerce-order-details.html"><span
                                                ...
                                                <td class="small text-center">
                                                    <h6 class="mb-0 w-px-100 text-warning"><i
                                                            class="bx bxs-circle fs-tiny me-2"></i>{{ $item->payment }}
                                                    </h6>
                                                </td>
