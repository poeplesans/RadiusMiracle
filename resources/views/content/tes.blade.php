                        ...
                        <ul class="list-group list-group-flush">
                          <li class="list-group-item list-group-item-action dropdown-notifications-item">
                            <div class="d-flex">
                              <div class="flex-shrink-0 me-3">
                                <div class="avatar">
                                  <img src="../resource/assets/img/avatars/1.png" alt class="w-px-40 h-auto rounded-circle" />
                                </div>
                              </div>
                          ...
                          <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                            <div class="d-flex">
                              <div class="flex-shrink-0 me-3">
                                <div class="avatar">
                                  <img src="../resource/assets/img/avatars/2.png" alt class="w-px-40 h-auto rounded-circle" />
                                </div>
                              </div>
                              <div class="flex-grow-1">
                          ...
                          <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                            <div class="d-flex">
                              <div class="flex-shrink-0 me-3">
                                <div class="avatar">
                                  <img src="../resource/assets/img/avatars/9.png" alt class="w-px-40 h-auto rounded-circle" />
                                </div>
                              </div>
                              <div class="flex-grow-1">
                          ...
                          <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                            <div class="d-flex">
                              <div class="flex-shrink-0 me-3">
                                <div class="avatar">
                                  <img src="../resource/assets/img/avatars/5.png" alt class="w-px-40 h-auto rounded-circle" />
                                </div>
                              </div>
                              <div class="flex-grow-1">
                          ...
                          <li class="list-group-item list-group-item-action dropdown-notifications-item">
                            <div class="d-flex">
                              <div class="flex-shrink-0 me-3">
                                <div class="avatar">
                                  <img src="../resource/assets/img/avatars/6.png" alt class="w-px-40 h-auto rounded-circle" />
                                </div>
                              </div>
                              <div class="flex-grow-1">
                  ...
                  <div class="card h-100">
                    <div class="card-header d-flex align-items-center justify-content-between">
                      <div class="d-flex align-items-center me-3">
                        <img src="../resource/assets/img/avatars/4.png" alt="Avatar" class="rounded-circle me-3" width="54" />
                        <div class="card-title mb-0">
                        ...
                        <div class="d-flex flex-column me-2">
                          ...
                          <ul class="list-unstyled me-2 d-flex align-items-center avatar-group mb-0">
                            <li
                              ...
                              <img class="rounded-circle" src="../resource/assets/img/avatars/5.png" alt="Avatar" />
                            </li>
                            <li
                              data-bs-toggle="tooltip"
                              data-popup="tooltip-custom"
                              ...
                              title="Allen Rieske"
                              class="avatar avatar-xs pull-up">
                              <img class="rounded-circle" src="../resource/assets/img/avatars/12.png" alt="Avatar" />
                            </li>
                            <li
                              data-bs-toggle="tooltip"
                              data-popup="tooltip-custom"
                              ...
                              class="avatar avatar-xs pull-up">
                              <img class="rounded-circle" src="../resource/assets/img/avatars/6.png" alt="Avatar" />
                            </li>
                            <li
                              data-bs-toggle="tooltip"
                              data-popup="tooltip-custom"
                              ...
                              title="Ellen Wagner"
                              class="avatar avatar-xs pull-up">
                              <img class="rounded-circle" src="../resource/assets/img/avatars/14.png" alt="Avatar" />
                            </li>
                            <li
                              data-bs-toggle="tooltip"
                              data-popup="tooltip-custom"
                              ...
                              title="Darcey Nooner"
                              class="avatar avatar-xs pull-up">
                              <img class="rounded-circle" src="../resource/assets/img/avatars/10.png" alt="Avatar" />
                            </li>
                          </ul>
                        </div>
                        <div class="d-flex flex-column me-2">
                          ...
                          <div class="timeline-event pb-2">
                            ...
                            <div class="d-flex">
                              <a href="javascript:void(0)" class="me-3">
                                <img
                                  src="../resource/assets/img/icons/misc/pdf.png"
                                  alt="PDF image"
                                  width="23"
                                  class="me-2" />
                          ...
                          <div class="timeline-event pb-2">
                            ...
                            <div class="d-flex flex-wrap">
                              <div class="avatar me-3">
                                <img src="../resource/assets/img/avatars/1.png" alt="Avatar" class="rounded-circle" />
                              </div>
                              <div>
                          ...
                          <div class="timeline-event pb-0">
                            ...
                            <div class="d-flex align-items-center avatar-group">
                              <div
                                ...
                                data-bs-placement="top"
                                title="Vinnie Mostowy">
                                <img src="../resource/assets/img/avatars/5.png" alt="Avatar" class="rounded-circle" />
                              </div>
                              <div
                                class="avatar avatar-sm pull-up"
                                data-bs-toggle="tooltip"
                                ...
                                data-bs-placement="top"
                                title="Marrie Patty">
                                <img src="../resource/assets/img/avatars/12.png" alt="Avatar" class="rounded-circle" />
                              </div>
                              <div
                                class="avatar avatar-sm pull-up"
                                data-bs-toggle="tooltip"
                                ...
                                data-bs-placement="top"
                                title="Jimmy Jackson">
                                <img src="../resource/assets/img/avatars/9.png" alt="Avatar" class="rounded-circle" />
                              </div>
                              <div
                                class="avatar avatar-sm pull-up"
                                data-bs-toggle="tooltip"
                                ...
                                data-bs-placement="top"
                                title="Kristine Gill">
                                <img src="../resource/assets/img/avatars/6.png" alt="Avatar" class="rounded-circle" />
                              </div>
                              <div
                                class="avatar avatar-sm pull-up"
                                data-bs-toggle="tooltip"
                                ...
                                data-bs-placement="top"
                                title="Nelson Wilson">
                                <img src="../resource/assets/img/avatars/14.png" alt="Avatar" class="rounded-circle" />
                              </div>
                            </div>
                          </div>
                        </li>
