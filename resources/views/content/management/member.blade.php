            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content p-3 p-md-5">
                    <div class="modal-body">
                        ...
                        <form id="editUserForm" class="update-user row" action="{{ url('/members/users/edit') }}" method="POST">
                            @csrf
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <form class="add-new-user row" id="addNewRoleForm" action="/members/role/add" onsubmit="return false">
                            @csrf
                            <div class="col-12 mb-3">
