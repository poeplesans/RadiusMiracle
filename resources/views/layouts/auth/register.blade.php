            ...
            <form id="formAuthentication" class="mb-3 fv-plugins-bootstrap5 fv-plugins-framework" action="/register"
                ...
                <div class="mb-3 fv-plugins-icon-container">
                    ...
                    <input type="text" class="form-control @error('username') is-invalid @enderror" id="username"
                        name="username" placeholder="Enter your username" autofocus="" required value="{{ old('username') }}">
                    @error('username')
                        <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                            {{ $message }}</div>
                    @enderror
                ...
                <div class="mb-3 fv-plugins-icon-container">
                    <label for="office_name" class="form-label">Office Name (ex: "Miracle Data Technology")</label>
                    <input type="text" class="form-control @error('office_name') is-invalid @enderror" id="office_name"
                        name="office_name" placeholder="Enter your office name" autofocus="" required value="{{ old('office_name') }}">
                    @error('office_name')
                        <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                            {{ $message }}</div>
                    @enderror
                ...
                <div class="mb-3 fv-plugins-icon-container">
                    <label for="office_name_short" class="form-label">Short Name Office (ex: "Miracle Tech")</label>
                    <input type="text" class="form-control @error('office_name_short') is-invalid @enderror" id="office_name_short"
                        name="office_name_short" placeholder="Enter your office name" autofocus="" required value="{{ old('office_name_short') }}">
                    @error('office_name_short')
                        <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                            {{ $message }}</div>
                    @enderror
                </div>
                <div class="mb-3 fv-plugins-icon-container">
                    <label for="desc" class="form-label">Phone Number (ex : "62XXXXXXX")</label>
                    <input type="text" class="form-control @error('desc') is-invalid @enderror" id="desc"
                        name="desc" placeholder="Enter your phone number" autofocus="" required value="{{ old('desc') }}">
                    @error('desc')
                        <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                            {{ $message }}</div>
                    @enderror
                ...
                <div class="mb-3 fv-plugins-icon-container">
                    ...
                    <input type="text" class="form-control @error('address') is-invalid @enderror" id="address"
                        name="address" placeholder="Enter your phone number" autofocus="" required value="{{ old('address') }}">
                    @error('address')
                        <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                            {{ $message }}</div>
                    @enderror
